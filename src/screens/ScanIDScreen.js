...
import { Platform, Button, TouchableHighlight, Text, View, StyleSheet, SafeAreaView, TouchableOpacity, Dimensions ,TextInput } from 'react-native'
                 ...
                 {/* remove */}
                    <View style={styles.searchHead} >
                        <TouchableOpacity style={{ alignItems: 'flex-start', margin: 20}} >
                                <Icon name="bars" size={25} color='#f9f9f9'
                                    onPress={this.props.navigation.openDrawer}/>
                                <TextInput placeholder="Search Here" 
                                    style={styles.search} 
                                    underlineColorAndroid='transparent' 
                                    placeholderTextColor = "#d5e6ee" />
                                <Icon style={styles.searchIcon} name='search' size={22} color='#f9f9f9' />
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                        <View style={styles.homeContent}>
                            <View style={styles.progressTextBlock}>
                                ...
                                {
                                this.state.scaning ? <Text style={styles.progressText} >We are processing your request...</Text>  : <Text style={styles.progressText} >Ready To Capture ID</Text>
                                }
                            </View>
                        </View>
                    </View>
                    <View style={{ flex: 2, alignItems: 'center', alignContent: 'center' ,padding:5 }}>
                        ...
                        <TouchableHighlight style={[styles.buttonContainer, styles.scanButton]} 
                                onPress={this.takePicture.bind(this)} underlayColor='#3286C9'>
                                <Text style={{ color: 'white', fontSize: 18, fontWeight: '600' }}>Capture Licence</Text>
                        </TouchableHighlight>
