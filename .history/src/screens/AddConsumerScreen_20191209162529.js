...
export default class AddConsumerScreen extends Component {
  ...
  render() {
    const progressStepsStyle = {
      ...
      completedStepIconColor: '#87CEEB',
      completedProgressBarColor: '#87CEEB',
                  ...
                  <ScrollView>
                    <View>
                      <View
                        ...
                        <Text style={{marginTop:12, marginLeft:8, color:'#8d8d8d', fontWeight:'bold', fontSize:16}}>Employement Status</Text>
