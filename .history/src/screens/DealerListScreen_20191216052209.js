...
const DealerItem = (item, navigation) => {
  ...
  return (
    <ListItem
      ...
      onPress={() => navigate('ViewDealer', {dealer: prop})}
      keyExtractor={item => item.document_number}
    />
  );
};
const DealerItem2 = (item, navigation) => {
  const {navigate} = navigation;
  console.log(navigate);
  return (
    <ListItem
          ...
          <FlatList
            ...
            renderItem={({item}) => {
              ...
              if (!item.verified == false) {
                console.log('true');
                return (
                  <DealerItem item={item} navigation={this.props.navigation} />
                );
              } else {
                console.log('false');
                return (
                  <DealerItem2 item={item} navigation={this.props.navigation} />
                );
              }
            }}
