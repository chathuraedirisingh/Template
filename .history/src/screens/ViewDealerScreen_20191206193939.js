      ...
      <View style={{flex: 1}}>
        ...
        <View
          ...
          <View
            ...
            <TouchableOpacity style={{ width: 80, height: 80, backgroundColor: 'white', borderRadius:10, alignContent:"center", alignItems:'center',paddingTop:5, margin:5, borderColor:'skyblue', borderWidth:1}}>
