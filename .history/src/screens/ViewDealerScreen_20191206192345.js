      ...
      <View style={{flex: 1}}>
        ...
        <View
          ...
          <View
            ...
            <TouchableOpacity style={{ width: 80, height: 80, backgroundColor: 'skyblue', borderRadius:10, alignContent:"center", alignItems:'center', padding:10, margin:5}}></TouchableOpacity>
            <TouchableOpacity style={{ width: 80, height: 80, backgroundColor: 'skyblue', borderRadius:10, alignContent:"center", alignItems:'center', padding:10, margin:5}}></TouchableOpacity>
          </View>
