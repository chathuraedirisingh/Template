...
import { Dimensions,
    ...
    StatusBar,
    ImageBackground ,
    TouchableHighlight , Alert , KeyboardAvoidingView } from 'react-native'
                ...
                <SafeAreaView style={{ flex: 1 }}>
                    ...
                    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                        <View style={styles.homeContent}>
                            ...
                            <ImageBackground source={require('../../assets/ID-Card.png')} 
                            style={styles.idImage}>
                            </ImageBackground>
                            </View>
                            <View>
                            <TouchableHighlight style={[styles.buttonContainer, styles.scanButton]} 
                                onPress={this.scan.bind(this)} underlayColor='#3286C9'>
