          ...
          <SafeAreaView style={{flex: 1}}>
            ...
            <View
              ...
              <View style={styles.homeContent}>
                <View>
                  <Text style={styles.greet}> Good Morning {data.lastName}</Text>
                </View>
                <View>
                <Image style={{width: 100, height: 50, resizeMode: Image.resizeMode.contain, borderWidth: 1, borderColor: 'red'}} source={{uri: 'data:image/png;base64,'+data.faceImage}}/>
                </View>
