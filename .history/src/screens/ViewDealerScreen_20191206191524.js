      ...
      <View style={{flex: 1}}>
        ...
        <View
          ...
          <View
            ...
            <TouchableOpacity style={{width: 80, height: 80, backgroundColor: 'powderblue'}}></TouchableOpacity>
            <TouchableOpacity style={{width: 80, height: 80, backgroundColor: 'skyblue'}}></TouchableOpacity>
            <TouchableOpacity style={{width: 80, height: 80, backgroundColor: 'steelblue'}}></TouchableOpacity>
            <TouchableOpacity style={{width: 80, height: 80, backgroundColor: 'skyblue'}}></TouchableOpacity>
          </View>
