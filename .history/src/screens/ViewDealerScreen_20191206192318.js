      ...
      <View style={{flex: 1}}>
        ...
        <View
          ...
          <View
            ...
            <TouchableOpacity style={{flex:1, width: 80, height: 80, backgroundColor: 'skyblue', borderRadius:10, alignContent:"center", alignItems:'center', padding:10, margin:5}}>
            <Icon
                  name="bars"
                  size={50}
                  color="#f9f9f9"
            ...
            <TouchableOpacity style={{flex:1, width: 100, height: 80, backgroundColor: 'skyblue', borderRadius:10, alignContent:"center", alignItems:'center', padding:10, margin:5}}></TouchableOpacity>
            <TouchableOpacity style={{flex:1, width: 80, height: 80, backgroundColor: 'skyblue', borderRadius:10, alignContent:"center", alignItems:'center', padding:10, margin:5}}></TouchableOpacity>
          </View>
