          ...
          <SafeAreaView style={{flex: 1}}>
            ...
            <View
              ...
              <View style={styles.homeContent}>
                <View>
                  <Text style={styles.greet}> Good Morning {data.firstName}</Text>
                </View>
                <View style={styles.imageContainer}>
                <Image style={styles.imageResult} resizeMode='contain' source={{uri: 'data:image/png;base64,'+data.fullDocumentImage}}/>
                </View>

                <View style={{marginLeft:15}}>
                <TouchableOpacity style={[styles.buttonContainer, styles.googleButton]}>
          <View style={styles.socialButtonContent}>
            <Icon name="check" size={28} color='green' style={styles.icon}/>
