            ...
            <View style={{ flex: 1 }}>
                ...
                <SafeAreaView
                    ...
                    <TouchableOpacity style={{ alignItems: 'flex-start', margin: 16, }} >
                        ...
                        <TextInput placeholder="Search Here" style={styles.search} underlineColorAndroid='transparent' placeholderTextColor = "#1c5dc987" onPress={this.props.navigation.openDrawer} />
